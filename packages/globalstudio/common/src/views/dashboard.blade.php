            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{GlobalStudio\Common\Models\Blog::count()}}</h3>
                            <p>Blogs</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{GlobalStudio\Common\Models\Service::count()}}</h3>
                            <p>Services</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3>{{GlobalStudio\Common\Models\Team::count()}}</h3>
                            <p>Teams</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{GlobalStudio\Common\Models\Contact::count()}}</h3>
                            <p>Contacts</p>
                        </div>
                        <div class="icon">
                                    ...
                                    @foreach (app('App\Helpers\Helper')->getBlogs(5) as $blog)
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="{{ asset('storage/blog/'.$blog->image) }}" alt="" class="img-size-50">
                                            </div>
