                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('admin.why_choose_us.delete') }}" method="post">
                                            @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-10 col-6">
                                    <input type="text" class="form-control" id="why-choose-us-search" placeholder="Search Why Choose Us"
                                        style="width: 100%;">
                                </div>
                ...
                var datatable = $('#why-choose-us-table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/why_choose_us/delete') }}" + '/' + row.id;

                                var edit = "{{ url('admin/why_choose_us/edit') }}" + '/' + row.id;
