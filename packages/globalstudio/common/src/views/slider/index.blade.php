        ...
        <div class="row">
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-lg-10 col-6">
                      <input type="text" class="form-control" id="slider-search"
                          placeholder="Search slider" style="width: 100%;">
                  </div>
              ...
              <div class="table-responsive">
                  <table class="table table-bordered table-hover dataTable dtr-inline" id="slider-table">
                      <thead>
                          <tr>
                              <th>SN</th>
                              <th>Name</th>
  ...
  @push('js')
        <script>
            $(document).ready(function() {
                var datatable = $('#slider-table').DataTable({
                    searching: false,
                    ...
                    ajax: {
                        ...
                        url: "{{ route('admin.slider.search') }}",
                        data: function(d) {
                            d.keyword = $('#slider-search').val();
                        }
                    },
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/sliders/delete') }}" + '/' + row.id;

                                    var edit = "{{ url('admin/sliders/edit') }}" + '/' + row.id;
                ...
                $('body').on('keyup', '#slider-search', function() {
                    setTimeout(function() {
