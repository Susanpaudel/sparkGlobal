            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        @endif
                        <form class="form" method="post" action="{{ route('admin.trader_choose_us.update') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $trader_choose_us->id }}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                value="{{ old('title',$trader_choose_us->title) }}" placeholder="Enter title" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Description" required>{{old('description',$trader_choose_us->description)}}</textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" rows="4" name="icon"
                                             placeholder="Enter icon" required>{{old('icon',$trader_choose_us->icon)}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="status"
                                                    @if ($trader_choose_us->status) checked @endif>
