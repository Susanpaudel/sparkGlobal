                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover dataTable dtr-inline" id="blog-table">
                                    <thead>
                                        <tr>
                                            <th>SN</th>
                                            <th>Name</th>
    ...
    @push('js')
        <script>
            $(document).ready(function() {
                var datatable = $('#blog-table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/blogs/delete') }}" + '/' + row.id;

                                var edit = "{{ url('admin/blogs/edit') }}" + '/' + row.id;
                ...
                $('body').on('keyup', '#blog-search', function() {
                    setTimeout(function() {
