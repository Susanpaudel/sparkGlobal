        ...
        <div class="row">
          ...
          <div class="card-body">
              ...
              <div class="table-responsive">
                  <table class="table table-bordered table-hover dataTable dtr-inline" id="user-table">
                      <thead>
                          <tr>
                              <th>SN</th>
                              <th>Name</th>
                ...
                var datatable = $('#user-table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/users/delete') }}" + '/' + row.id;

                                    var edit = "{{ url('admin/users/edit') }}" + '/' + row.id;
