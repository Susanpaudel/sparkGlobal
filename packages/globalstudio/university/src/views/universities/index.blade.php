          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-lg-10 col-6">
                      <input type="text" class="form-control" id="univesity-search"
                          placeholder="Search univesity" style="width: 100%;">
                  </div>
              ...
              <div class="table-responsive">
                  <table class="table table-bordered table-hover dataTable dtr-inline" id="university-table">
                      <thead>
                          <tr>
                              <th>SN</th>
                              <th>Name</th>
  ...
  @push('js')
        <script>
            $(document).ready(function() {
                var datatable = $('#university-table').DataTable({
                    searching: false,
                    ...
                    ajax: {
                        ...
                        url: "{{ route('admin.university.search') }}",
                        data: function(d) {
                            d.keyword = $('#univesity-search').val();
                        }
                    },
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/universities/delete') }}" + '/' + row.id;

                                    var edit = "{{ url('admin/universities/edit') }}" + '/' + row.id;
                    ...
                    bLengthChange: false // hide the records per univesity dropdown

                }).on('xhr.dt', function(e, settings, json, xhr) {

                });

                $('body').on('keyup', '#univesity-search', function() {
                    setTimeout(function() {
