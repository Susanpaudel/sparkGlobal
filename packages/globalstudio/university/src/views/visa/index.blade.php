              ...
              <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                          <form action="{{ route('admin.visa.delete') }}" method="post">
                              @csrf
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-lg-10 col-6">
                      <input type="text" class="form-control" id="visa-search"
                          placeholder="Search Visa" style="width: 100%;">
                  </div>
              ...
              <div class="table-responsive">
                  <table class="table table-bordered table-hover dataTable dtr-inline" id="visa-table">
                      <thead>
                          <tr>
                              <th>SN</th>
                              <th>Name</th>
  ...
  @push('js')
        <script>
            $(document).ready(function() {
                var datatable = $('#visa-table').DataTable({
                    searching: false,
                    ...
                    ajax: {
                        ...
                        url: "{{ route('admin.visa.search') }}",
                        data: function(d) {
                            d.keyword = $('#visa-search').val();
                        }
                    },
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/visa/delete') }}" + '/' + row.id;

                                    var edit = "{{ url('admin/visa/edit') }}" + '/' + row.id;
                    ...
                    bLengthChange: false // hide the records per visa dropdown

                }).on('xhr.dt', function(e, settings, json, xhr) {

                });

                $('body').on('keyup', '#visa-search', function() {
                    setTimeout(function() {
