            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        @endif
                        <form class="form" method="post" action="{{ route('admin.visa.store') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 col-12">
                                                    <label for="exampleInputPassword1">Icon<span class="required">*</span><a
                                                            ...
                                                            class="ml-3">Font Awesome Link</a></label>
                                                    <input type="text" class="form-control" name="icon"
                                                        placeholder="fa fa-television" required>
                                                </div>
