        ...
        <div class="row">
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-lg-10 col-6">
                      <input type="text" class="form-control" id="course-search"
                          placeholder="Search Courses" style="width: 100%;">
                  </div>
              ...
              <div class="table-responsive">
                  <table class="table table-bordered table-hover dataTable dtr-inline" id="course-table">
                      <thead>
                          <tr>
                              <th>SN</th>
                              <th>Name</th>
                ...
                var datatable = $('#course-table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/courses/delete') }}" + '/' + row.id;

                                    var edit = "{{ url('admin/courses/edit') }}" + '/' + row.id;
                    ...
                    bLengthChange: false // hide the records per course dropdown

                }).on('xhr.dt', function(e, settings, json, xhr) {

                });

                $('body').on('keyup', '#course-search', function() {
                    setTimeout(function() {
