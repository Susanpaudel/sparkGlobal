        ...
        <div class="row">
              ...
              <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                          <form action="{{ route('admin.destination.delete') }}" method="post">
                              @csrf
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-lg-10 col-6">
                      <input type="text" class="form-control" id="destination-search"
                          placeholder="Search Destinations" style="width: 100%;">
                  </div>
              ...
              <div class="table-responsive">
                  <table class="table table-bordered table-hover dataTable dtr-inline" id="destination-table">
                      <thead>
                          <tr>
                              <th>SN</th>
                              <th>Name</th>
  ...
  @push('js')
        <script>
            $(document).ready(function() {
                var datatable = $('#destination-table').DataTable({
                    searching: false,
                    ...
                    ajax: {
                        ...
                        url: "{{ route('admin.destination.search') }}",
                        data: function(d) {
                            d.keyword = $('#destination-search').val();
                        }
                    },
                    columns: [{
                        ...
                        },
                        {
                            data: 'action',
                            render: function(data, type, row) {
                                var del = "{{ url('admin/destinations/delete') }}" + '/' + row.id;

                                    var edit = "{{ url('admin/destinations/edit') }}" + '/' + row.id;
                    ...
                    bLengthChange: false // hide the records per destination dropdown

                }).on('xhr.dt', function(e, settings, json, xhr) {

                });

                $('body').on('keyup', '#destination-search', function() {
                    setTimeout(function() {
